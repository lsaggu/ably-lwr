...
*/
/* LWR Legacy Module Loader Shim v0.7.4 */
(function () {
  'use strict';
  ...
  class LoaderShim {
      constructor(global) {
          ...
          this.loaderModule = 'lwr/loaderLegacy/v/0_7_4';
      ...
      createProfilerModule(loader) {
          ...
          loader.define('lwr/profiler/v/0_7_4', ['exports'], exporter, {});
      }
  ...
  if (GLOBAL.LWR.requiredModules.indexOf('lwr/loaderLegacy/v/0_7_4') < 0) {
      GLOBAL.LWR.requiredModules.push('lwr/loaderLegacy/v/0_7_4');
  }
  new LoaderShim(GLOBAL);

}());

LWR.define('lwr/loaderLegacy/v/0_7_4', ['exports'], function (exports) { 'use strict';
