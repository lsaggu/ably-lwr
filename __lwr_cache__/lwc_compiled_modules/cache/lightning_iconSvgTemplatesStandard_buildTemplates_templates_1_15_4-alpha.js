...
export default {
  ...
  standard_activation_target,
  standard_activations,
  standard_address,
  standard_agent_home,
  standard_agent_session,
  standard_aggregation_policy,
  standard_ai_accelerator_card,
  standard_all,
  ...
  standard_brand,
  standard_budget,
  standard_budget_allocation,
  standard_bundle_config,
  standard_bundle_policy,
  standard_business_hours,
  standard_buyer_account,
  standard_buyer_group,
  standard_calculated_insights,
  ...
  standard_care_request_reviewer,
  standard_carousel,
  standard_case,
  ...
  standard_code_set,
  standard_code_set_bundle,
  standard_collection,
  standard_collection_variable,
  standard_connect_wallet,
  ...
  standard_contract_line_outcome,
  standard_contract_line_outcome_data,
  standard_contract_payment,
  standard_coupon_codes,
  standard_crypto_category_wallet_group,
  standard_crypto_product,
  standard_crypto_product_category_wallet_role,
  standard_crypto_transaction,
  standard_crypto_transaction_envelope,
  standard_crypto_transaction_envelope_item,
  standard_crypto_wallet,
  standard_crypto_wallet_group,
  standard_crypto_wallet_group_item,
  standard_currency,
  standard_currency_input,
  standard_custom,
  standard_custom_component_task,
  standard_custom_notification,
  standard_customer,
  standard_customer_360,
  standard_customer_lifecycle_analytics,
  standard_customer_portal_users,
  standard_customer_workspace,
  standard_customers,
  standard_dashboard,
  standard_dashboard_component,
  ...
  standard_document,
  standard_document_reference,
  standard_drafts,
  standard_duration_downscale,
  ...
  standard_feed,
  standard_feedback,
  standard_field_sales,
  standard_file,
  standard_filter,
  standard_filter_criteria,
  standard_filter_criteria_rule,
  ...
  standard_groups,
  standard_guidance_center,
  standard_hierarchy,
  standard_high_velocity_sales,
  standard_historical_adherence,
  standard_holiday_operating_hours,
  standard_home,
  standard_household,
  standard_identifier,
  standard_immunization,
  standard_incident,
  standard_individual,
  standard_insights,
  ...
  standard_med_rec_recommendation,
  standard_med_rec_statement_recommendation,
  standard_medication,
  standard_medication_dispense,
  standard_medication_ingredient,
  standard_medication_reconciliation,
  standard_medication_statement,
  standard_merge,
  ...
  standard_network_contract,
  standard_news,
  standard_nft_settings,
  standard_nft_studio,
  standard_note,
  standard_number_input,
  standard_observation_component,
  ...
  standard_password,
  standard_past_chat,
  standard_patient_medication_dosage,
  standard_payment_gateway,
  standard_people,
  standard_performance,
  standard_person_account,
  standard_person_language,
  ...
  standard_record_signature_task,
  ...
  standard_scheduling_constraint,
  standard_scheduling_policy,
  standard_screen,
  standard_search,
  standard_section,
  standard_segments,
  standard_selling_model,
  standard_serialized_product,
  standard_serialized_product_transaction,
