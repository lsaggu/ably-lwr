...
const $fragment1 = parseSVGFragment`<g${3}><rect x="2" y="43.6" width="48" height="6.4" rx="1.6"${3}><rect data-name="Rectangle" x="18.8" y="2" width="14.4" height="37.6" rx="3.2"${3}></g>`;
