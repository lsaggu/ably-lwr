...
import { assert, getRealDOMId, normalizeAriaAttribute, normalizeBoolean, normalizeString, synchronizeAttrs, computeAriaInvalid } from 'lightning/utilsPrivate'; // remove-next-line-for-c-namespace
...
_registerDecorators(LightningBaseCombobox, {
  ...
  fields: ["_inputDescribedBy", "_inputAriaControls", "_activeElementDomId", "_autocomplete", "originDisableDefaultHighlight", "privateDisableDefaultHighlight"]
});
